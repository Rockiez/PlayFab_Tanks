...
namespace Complete
{
    ...
    public class TankManager
    {
        ...
        [HideInInspector] public string m_PlayerNickName;            // This specifies which player this the manager for.
        ...
        public void Setup ()
        {
            ...
            m_ColoredPlayerText = "<color=#" + ColorUtility.ToHtmlStringRGB(m_PlayerColor) + ">PLAYER " + m_PlayerNickName + "</color>";
